...
- **Conditional edges:** ArtDirector routes to StoryReviewer or directly to Decision based on the `enable_story_reviewer` flag in the request (controlled via a checkbox on the story creation form).
