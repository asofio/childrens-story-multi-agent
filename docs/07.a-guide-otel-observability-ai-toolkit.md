...
[← Back to README](../README.md) | [Prerequisites & Setup](01-prerequisites-and-setup.md) | [Architecture Overview](02-architecture-overview.md) | [Aspire Dashboard variant →](07.b-guide-otel-observability-aspire.md)
...
> **Prefer a browser-based dashboard?** The [Aspire Dashboard variant](07.b-guide-otel-observability-aspire.md) of this guide uses the .NET Aspire Dashboard (Docker) as the trace viewer instead.
...
- Try the [Aspire Dashboard variant](07.b-guide-otel-observability-aspire.md) to see how the same traces look in a browser-based waterfall view — useful for demos and screen sharing.
