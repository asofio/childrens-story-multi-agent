...
[← Back to README](../README.md) | [Prerequisites & Setup](01-prerequisites-and-setup.md) | [Architecture Overview](02-architecture-overview.md) | [AI Toolkit variant →](06.a-guide-otel-observability-ai-toolkit.md)
...
> **Prefer staying in VS Code?** The [AI Toolkit variant](06.a-guide-otel-observability-ai-toolkit.md) of this guide shows the same OTEL instrumentation but uses the **AI Toolkit for VS Code** to view traces directly in your editor — no Docker required.
